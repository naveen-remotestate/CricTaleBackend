...
func CreateTeam(tx *sqlx.Tx, teamName string, hostedBy string) (string, error) {
...
func AddPlayerToTeam(tx *sqlx.Tx, teamID string, player models.TeamPlayerInput) error {
...
func CreateMatch(tx *sqlx.Tx, teamAID string, teamBID string, tossWinnerID string, tossDecision string, battingFirstTeamID string, overs int, hostedBy string) (string, error) {
